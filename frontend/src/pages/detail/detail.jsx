                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                            ...
                            <div className="col-span-1 lg:col-span-8">
                                ...
                                <p className="text-base sm:text-lg md:text-xl text-white-400 mb-4">
                                    Lập trình Python từ cơ bản đến nâng cao
                                    thông qua các dự án với sự hỗ trợ của trí
                                    tuệ nhân tạo AI
                                </p>
                                {/* Đánh giá */}
                                ...
                                <p className="text-xs sm:text-sm text-white-400 flex items-center">
                                    <box-icon
                                        ...
                                        size="sm"
                                    />
                                    Lần cập nhật gần đây nhất 8/2024
                                </p>
                        ...
                        <div className="w-full lg:w-2/3 px-4">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 overflow-hidden">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li className="flex items-start lesson-content collapsed">
                                            Biết cách lập trình hướng đối tượng
                                            với lớp (class), kế thừa, đa hình
                                        </li>
                                        <li className="flex items-start lesson-content collapsed">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md mt-8">
                                ...
                                <div className="text-gray-700 text-lg font-bold mb-4">
                                    Các công ty hàng đầu cung cấp khóa học này
                                    cho nhân viên
                                </div>
                                <p className="text-gray-600 mb-4">
                                    Chúng tôi lựa chọn khóa học này cho tuyển
                                    tập khóa học đầu bảng được các doanh nghiệp
                                    toàn cầu tin dùng.
                                    <a
                                        href="#"
                                ...
                                <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 items-center">
                                    <div className="w-full lg:w-1/2">
                                        ...
                                        <p className="text-gray-600 mb-4">
                                            Khóa học này bao gồm các bài tập
                                            coding được cập nhật của chúng tôi
                                            để bạn có thể thực hành các kỹ năng
                                            của bạn khi học.
                                        </p>
                                        <a
                                            href="#"
                            ...
                            <div className="container mx-auto px-4 py-8">
                                ...
                                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                                    ...
                                    <div className="border-b">
                                        ...
                                        >
                                            <span className="font-medium">
                                                Khai báo biến và chuyển đổi kiểu
                                ...
                                <ul className="list-disc pl-8">
                                    <li>
                                        Có kiến thức cơ bản về kiến trúc máy
                                        tính
                                    </li>
                                    <li>
                                        Có máy tính nối mạng Internet để thực
                                        hành các bài tập
                                    </li>
                                </ul>
                                {/* Mô tả */}
                                <div className="section-3-content collapsed mt-4">
                                    ...
                                    <p className="text-black-600 mb-6">
                                        Khóa học{" "}
                                        <strong>
                                            Lập trình Python từ cơ bản đến nâng
                                            cao thông qua các dự án
                                        </strong>{" "}
                                        được thiết kế để giúp bạn từ bước đầu
                                        làm quen đến thành thạo trong việc sử
                                        dụng Python - một trong những ngôn ngữ
                                        lập trình phổ biến và mạnh mẽ nhất hiện
                                        nay. Khóa học này cung cấp một lộ trình
                                        học tập rõ ràng và thực tế, hướng dẫn
                                        bạn qua từng bước cụ thể từ việc cài đặt
                                        môi trường phát triển, khai báo biến,
                                        làm việc với chuỗi ký tự, đến việc xây
                                        dựng các dự án phức tạp hơn.
                                    </p>
                                    <p className="text-black-600 mb-6">
                                    ...
                                    <ul className="list-disc pl-8 mb-6">
                                        <li>
                                            ...
                                            ngôn ngữ lập trình Python, cách cài
                                            đặt và tùy chỉnh môi trường phát
                                            triển PyCharm, và viết các chương
                                            trình Python đầu tiên của mình.
                                        </li>
                                        <li>
                                            <strong>
                                                Thành thạo các khái niệm lập
                                                trình cơ bản:
                                            </strong>{" "}
                                            Khóa học sẽ hướng dẫn bạn về khai
                                            báo biến, các kiểu dữ liệu, và cách
                                            chuyển đổi chúng, cũng như cách sử
                                            dụng các phép toán và cấu trúc điều
                                            khiển trong Python.
                                        </li>
                                        <li>
                                            <strong>
                                                Làm việc với các cấu trúc dữ
                                                liệu:
                                            </strong>{" "}
                                            Bạn sẽ học cách làm việc với các cấu
                                            trúc dữ liệu quan trọng như chuỗi ký
                                            tự, danh sách (List), bộ (Tuple), từ
                                            điển (Dictionary), và tập hợp (Set).
                                        </li>
                                    </ul>
                                    <p className="text-black-600 mb-6">
                                    ...
                                    <ul className="list-disc pl-8 mb-6">
                                        <li>
                                            Kiến thức toàn diện: Từ những khái
                                            niệm cơ bản đến các ứng dụng nâng
                                            cao, khóa học bao quát mọi khía cạnh
                                            cần thiết để bạn trở thành một lập
                                            trình viên Python tự tin.
                                        </li>
                                        <li>
                                            Thực hành liên tục: Các bài tập thực
                                            hành và dự án cụ thể sẽ giúp bạn áp
                                            dụng ngay những gì đã học vào thực
                                            tế.
                                        </li>
                                    </ul>
                                    <p className="text-gray-600 mb-6">
                                        Dù bạn là người mới bắt đầu hay đã có
                                        kinh nghiệm lập trình và muốn mở rộng
                                        kiến thức, khóa học này sẽ trang bị cho
                                        bạn những kỹ năng và hiểu biết cần thiết
                                        để tiến xa hơn trong sự nghiệp lập trình
                                        Python. Hãy tham gia cùng chúng tôi và
                                        khám phá tiềm năng của Python ngay hôm
                                        nay!
                                    </p>
                                    {/* Đối tượng khóa học */}
                                    <h2 className="text-2xl font-bold mb-4">
                                    ...
                                    <ul className="list-disc pl-8">
                                        <li>
                                            ...
                                            Python để phát triển các dự án về
                                            Web, IoT, phân tích dữ liệu, AI
                                        </li>
                                    </ul>
                                </div>
                                <button
                                ...
                                <div className="flex items-start bg-white p-6 rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-700 leading-relaxed instructor-content collapsed">
                                            Hello there! I am Bill Toan. I have
                                            a masters degree in computer system
                                            information. Ive been a Cisco
                                            instructor since 2010. I hold CCNA,
                                            CCNP Security, and Security+
                                            certification. My favorite teaching
                                            courses are CCNA and CCNP Security.
                                            I come from a background of network
                                            security engineer, and now I am
                                            focusing on IoT and OT security and
                                            applied machine learning techniques
                                            on network security. I have worked
                                            for over 14+ years on building
                                            enterprise security solutions using
                                            Cisco products. I have been a
                                            super-moderator of a network
                                            security forum named Whitehat for
                                            more than 10 years. I love sharing
                                            my experience with students and
                                            inspiring them to the cyber security
                                            world.
