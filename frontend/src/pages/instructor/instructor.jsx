                    ...
                    <div className="flex-1">
                        ...
                        <div className="p-6">
                            ...
                            <div className="bg-white rounded-lg shadow-lg p-6 my-5">
                                ...
                                <div className="h-auto rounded text-left py-5">
                                    <Table>
                                        <TableCaption>
                                            <div className="py-5">
                                                <svg width="100%" height="177" viewBox="0 0 139 142" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <TableHeader>
                                            <TableRow>
                                                <TableHead className="w-[33%]">Khòa học của bạn</TableHead>
                                                <TableHead className="w-[33%]">Ngày tham gia</TableHead>
                                                <TableHead className="w-[33%]">Tiến trình</TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                            <TableRow>
                            ...
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                ...
                                <div className="grid-left">
                                    <div className="bg-white rounded-lg shadow-lg p-6">
                                        <div className="flex justify-between items-center">
                                            <h3 className="text-xl font-bold">Lộ trình đạo tạo của tôi</h3>
                                            <div className="flex space-x-2">
                                                <button className="px-3 py-1 rounded-full text-white bg-yellow-400 hover:bg-purple-100 ">
                                                    <p className="font-bold">Xem tất cả</p>
                                                </button>
                                ...
                                <div className="grid-right">
                                    <div className="bg-white rounded-lg shadow-lg p-6">
                                        <div className="flex justify-between items-center">
                                            <h3 className="text-xl font-bold">Kỳ thi sắp diễn ra</h3>
                                            <div className="flex space-x-2">
                                                <button className="px-3 py-1 rounded-full text-white bg-yellow-400 hover:bg-purple-100 ">
                                                    <p className="font-bold">Xem tất cả</p>
                                                </button>
