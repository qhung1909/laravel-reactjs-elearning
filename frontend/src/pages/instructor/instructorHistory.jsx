                    ...
                    <div className="flex-1">
                        ...
                        <div className="p-6 max-lg:h-screen">
                            <div className=" flex justify-center">
                                <input type="text" placeholder="Nhập 1 từ khóa bất kỳ muốn tìm kiếm" className="w-[90%] p-3 rounded-tl-xl rounded-bl-xl"/>
                                <button className="bg-yellow-400 p-2 rounded-tr-xl rounded-br-xl font-semibold">Tìm kiếm</button>
                            </div>
                            <div className="my-20">
