                            ...
                            <div className="flex items-start gap-5 xl:w-2/3 md:w-2/5">
                                ...
                                <div className="footer-mid-left md:w-1/3 sm:w-1/4 w-1/3">
                                    ...
                                    <ul className="mt-1 space-y-1">
                                        <li className="text-xs text-gray-500 md:leading-9 sm:leading-7 leading-loose"><Link to='/courses'>Khóa học</Link></li>
                                        <li className="text-xs text-gray-500 md:leading-9 sm:leading-7 leading-loose"><Link to='/blog'>Bài viết</Link></li>
                                        <li className="text-xs text-gray-500 md:leading-9 sm:leading-7 leading-loose"><Link to='/contact'>Liên hệ</Link></li>
                                    </ul>
                                </div>
                                ...
                                <div className="footer-mid-right">
                                    ...
                                    <ul className="mt-1 space-y-1">
                                        {/* term */}
                                        <Link to="/terms">
                                            <li className="text-xs text-gray-500 md:leading-9 sm:leading-7 leading-loose">Điều khoản dịch vụ</li>
                                        </Link>
                                        {/* about us */}
                                        <Link to="/aboutus">
                                            <li className="text-xs text-gray-500 md:leading-9 sm:leading-7 leading-loose">Về chúng tôi</li>
                                        </Link>
                                    </ul>
                                </div>
                            </div>
