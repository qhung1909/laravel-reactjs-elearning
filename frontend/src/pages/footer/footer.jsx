            ...
            <footer className="bg-gray-200 h-auto lg:rounded-tl-[100px] lg:rounded-tr-[100px] md:rounded-tl-[50px] md:rounded-tr-[50px] rounded-tl-[50px] rounded-tr-[50px] md:py-5 lg:px-8 xl:px-0 mx-auto">
                <section className="xl:max-w-screen-2xl lg:max-w-screen-lg mx-auto pt-[50px] lg:px-10 md:px-10">
                    <div className="grid grid-cols-5 ">
                        ...
                        {/* end */}
                        <div className="footer-end col-span-2 ps-[10px] md:ps-[20px] xl:ps-[0px]">
                            <div className="footer-end-head mt-3 sm:mt-2 md:mt-1 xl:mt-0 md:mb-3 mb-2 lg:mb-0">
                                <p className="text-[#344054] font-semibold lg:mb-3 xl:text-[18px] lg:text-[12px] md:text-[12px] sm:text-[10px] text-[6px]">
                            ...
                            <div className="hotline md:mt-5 mt-1 font-semibold xl:text-[18px] lg:text-[12px] md:text-[10px] sm:text-[8px] text-[6px]">
