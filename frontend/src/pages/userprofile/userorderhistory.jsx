        ...
        return loading ? (
            ...
            orderHistory.map((item, index) => {
                return (
                    <TableRow key={index} className="sm:p-4 p-0">
                        <TableCell className="sm:p-4 py-2 px-0 xl:w-[400px] lg:w-[250px] md:w-[200px] w-fit font-medium lg:text-base text-sm ">
                            <p className="line-clamp-2">{item.courses && item.courses[0] ? item.courses[0].course_title : "Lỗi hiển thị tên khóa học"}</p>
                        </TableCell>

                        <TableCell className="sm:p-4 py-2 px-0 lg:text-base text-sm">
                            {item.status}
                        </TableCell>
                        <TableCell className="sm:p-4 py-2 px-0 lg:text-base text-sm">
                            {item.payment_method}
                        </TableCell>
                        <TableCell className="sm:p-4 py-2 px-0 text-right lg:text-base text-sm">
                            {item.total_price}
                        </TableCell>
                    </TableRow>
                );
            ...
            <TableRow>
                <TableCell colSpan={4} className="text-center py-4">
                    ...
                    <span className="text-base font-semibold text-blue-900 ">Bạn chưa mua khóa học nào</span>
                </TableCell>
            </TableRow>
        );
    };
