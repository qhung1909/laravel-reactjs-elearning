            ...
            <header>
                <nav className="navbar flex items-center justify-center w-full mx-auto py-2 z-10 ps-3 xl:max-w-screen-2xl">
                    ...
                    <div className="navbar-logo mx-2 w-20 h-24 object-cover flex items-center">
                        <Link to="/">
                            <img
                                src="https://lmsantlearn.s3.ap-southeast-2.amazonaws.com/uploads/antlearn.png"
                                alt=""
                                className="w-40"
                            />
                        </Link>
                        ...
                        ? (
                            ...
                            <>
                                ...
                                <div className="navbar-content  bg-white xl:flex xl:items-center px-5 xl:px-1 max-xl:w-full xl:block hidden">
                                    <ul className="max-xl:pt-3 px-8 gap-4 font-semibold flex text-base xl:text-base w-full items-center justify-center">
                                ...
                                <div className=" xl:hidden flex items-center justify-between">
                                    <Sheet>
                                        <SheetTrigger>
                                            <div className="flex items-center">
                                                <img src="./src/assets/images/toggle.svg" className="w-8" alt="" />
                                            </div>
                                        </SheetTrigger>
                                        <SheetContent>
                                            <SheetHeader>
