            ...
            <SidebarInset>
                    ...
                    <div className="flex items-center gap-2 px-4">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbSeparator />
                                <BreadcrumbItem>
                                    <BreadcrumbLink href="/schedule-list">Danh sách lịch dạy của giảng viên</BreadcrumbLink>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
                ...
                <div className="absolute top-16 px-6 bg-gray-50 w-full font-sans overflow-auto p-6">
                    <div className="flex justify-between items-center mb-2 mr-6 ml-2">
                        <h1 className="text-2xl font-semibold mb-4">Danh sách lịch dạy của giảng viên</h1>
