...
<head>
    ...
    <title>Thông báo lịch dạy đầu tiên</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h1 style="margin: 0 0 20px; color: #111827; font-size: 24px; font-weight: 700; text-align: center;">
                                Thông báo lịch dạy khóa học
                            </h1>

                            <p style="margin: 0 0 25px; color: #374151; font-size: 16px; line-height: 24px;">
                                Xin chào giảng viên <strong style="color: #111827;">{{ $instructor->name }}</strong>,
                            </p>

                            <p style="margin: 0 0 25px; color: #374151; font-size: 16px; line-height: 24px;">
                                Khóa học "<strong style="color: #111827;">{{ $course->title }}</strong>" đã có học viên đăng ký.
                                Lịch học đầu tiên của khóa học đã được tạo.
                            </p>
                            ...
                            <div style="background-color: #f8fafc; border-radius: 8px; padding: 25px; margin: 30px 0;">
                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; color: #374151; font-size: 15px;">
                                            <strong style="color: #111827;">Thời gian bắt đầu:</strong>
                                        </td>
                                        <td style="padding: 8px 0; color: #374151; font-size: 15px;">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; color: #374151; font-size: 15px;">
                                            <strong style="color: #111827;">Thời gian kết thúc:</strong>
                                        </td>
                                        <td style="padding: 8px 0; color: #374151; font-size: 15px;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="text-align: center; padding: 30px 0;">
                                        <a href="{{ 'http://localhost:5173/instructor/schedule' }}"
                            ...
                            <p style="margin: 30px 0 0; color: #374151; font-size: 16px; line-height: 24px;">
                                Nếu bạn cần điều chỉnh lịch dạy hoặc có bất kỳ thắc mắc nào, vui lòng liên hệ với quản trị viên.
                            </p>

                            <p style="margin: 20px 0 0; color: #374151; font-size: 16px; line-height: 24px;">
                                Chúc bạn có buổi dạy hiệu quả!
                            </p>
                        </td>
                    </tr>
